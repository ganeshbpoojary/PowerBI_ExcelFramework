	...
	public void validateProcessEfficiency_Space() {
		synchronized (SPlanning_Logic.class) {
			try {
				...
				// TODO Auto-generated catch block
				extentTest.log(LogStatus.FAIL, "Proces efficiency details are disabled",
						"Proces efficiency has no Data");
				e.printStackTrace();
			}
		}
	...
	public void verifyCapacityDemandtoggle_Space() {
		synchronized (SPlanning_Logic.class) {
			try {
				...
				clickOn(SPlanning_UI.spaceToggle);
				isDisplayed(SPlanning_UI.toggleOffQuestions);
				extentTest.log(LogStatus.PASS, " CapacityDemand Toggle  is enabled",
						" CapacityDemand Toggle is enabled");
			} catch (Exception e) {
				// TODO Auto-generated catch block
				extentTest.log(LogStatus.FAIL, " CapacityDemand Toggle  is disabled",
						"CapacityDemand Toggle  is disabled");
				e.printStackTrace();
			}
		}
	}
	...
	public void verifyInventoryTurnsToggle_Space() {
		synchronized (SPlanning_Logic.class) {
			try {
				...
				clickOn(SPlanning_UI.spaceToggle);
				isDisplayed(SPlanning_UI.toggleOffQuestions);
				extentTest.log(LogStatus.PASS, " InventoryTurnsToggle  is enabled",
						" InventoryTurns Toggle is enabled");
			} catch (Exception e) {
				// TODO Auto-generated catch block
				extentTest.log(LogStatus.FAIL, " InventoryTurnsToggle  is disabled",
						"InventoryTurnsToggle  is disabled");
				e.printStackTrace();
			}
		}
		...
		synchronized (SPlanning_Logic.class) {
			try {
				...
				if (chartElm.size() > 0) {
					...
					extentTest.log(LogStatus.PASS, " CapacityDemand_Chart  is enabled",
							"CapacityDemand_Chart is enabled");
				}
				return;

			} catch (Exception e) {
				// TODO Auto-generated catch block
				extentTest.log(LogStatus.FAIL, " CapacityDemand_Chart  is disabled",
						"CapacityDemand_Chart  is enabled");
				e.printStackTrace();
			}
		}
		...
		synchronized (SPlanning_Logic.class) {
			try {
				...
				if (restChart.size() > 0) {
					...
					extentTest.log(LogStatus.PASS, "CapacityDemand_ResetCalendarChart is enabled",
							"CapacityDemand_ResetCalendarChart is enabled");
				}
				return;

			} catch (Exception e) {
				// TODO Auto-generated catch block
				extentTest.log(LogStatus.FAIL, "CapacityDemand_ResetCalendarChart is disabled",
						"CapacityDemand_ResetCalendarChart  is enabled");
				e.printStackTrace();
			}
		}
	...
	public void verifyResetCalender_Space() {
		synchronized (SPlanning_Logic.class) {
			try {
				...
				getElementsCount(SPlanning_UI.chart_ResetCalender);
				if (getElementsCount(SPlanning_UI.chart_ResetCalender) > 0)
					extentTest.log(LogStatus.PASS, "Search Buttton should be present", "Search Buttton is present");
				else
					extentTest.log(LogStatus.FAIL, "Search Buttton should be present", "Search Buttton is not present");				
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void validate_InventoryTurns_Chart_Space() {
		synchronized (SPlanning_Logic.class) {
			try {
				...
				waitForElementTobeLocated(SPlanning_UI.lnk_InventoryTurns);
//				clickOn(SPlanning_UI.lnk_InventoryTurns);
				jsClickOn(SPlanning_UI.lnk_InventoryTurns);
				waitForPageToLoad();
				waitForElementTobeLocated(SPlanning_UI.chart_InventoryTurns);
				if (getElementsCount(SPlanning_UI.chart_InventoryTurns) > 0) {
					isDisplayed(SPlanning_UI.chart_InventoryTurns);
					extentTest.log(LogStatus.PASS, "InventoryTurns Chart should be enabled",
							"InventoryTurns_Chart is enabled");
				} else {
					extentTest.log(LogStatus.FAIL, "InventoryTurns Chart should be enabled",
							"InventoryTurns_Chart is not enabled");
				}
			} catch (Exception e) {
				e.printStackTrace();
			}
...
//				jsClickOn(SPlanning_UI.alertMorebutton);
				...
				if (Alerttable.size() > 1)
					for (int i = 0; i < Alerttable.size(); i++) {
						...
						extentTest.log(LogStatus.PASS, "Alert and details page   is enabled",
								" Alert and details page  is enabled");
					}

			} catch (Exception e) {
				// TODO Auto-generated catch block
				extentTest.log(LogStatus.FAIL, " Alert and details page   is disabled",
						"Alert and details page   is disabled");
				e.printStackTrace();
			}
		}
	...
	public void clickonFilterandValidatethedata_Space(String Filtername) {
		...
		driver.findElement(By.xpath("//*[@aria-label='" + Filtername
